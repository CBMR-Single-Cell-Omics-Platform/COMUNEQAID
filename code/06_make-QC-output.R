...
suppressMessages({
  ...
  samplesheet.sample2rnx <- full_join(
    as_tibble(snakemake@config[["sample_sheet"]]),
...
for (seq.id in seq.sheet[["sequencing_id"]]) {
  ...
  ggsave(
    filename = paste0("00_top-undetermined-barcodes.png"),
  ...
  ggsave(
    filename = paste0("00_read-index-distribution.png"),
...
for (rnx in snakemake@config[["reaction_sheet"]][["reaction_id"]]) {
  ...
  p.celular.barcode.calling <- make_plot_barcodeRanks(
  ...
  ggsave(
    filename = "01_barcode-calling.png",
  ...
  ggsave(
    filename = "02_antibody-calling.png",
  ...
  ggsave(
    filename = "02_HTO-counts_violin_global.png",
  ...
  ggsave(
    filename = "02_HTO-counts_violin_sample.png",
  ...
  ggsave(
    filename = "02_HTO-counts_tSNE_global.png",
  ...
  ggsave(
    filename = "02_HTO-counts_tSNE_sample.png",
  ...
  ggsave(
    filename = "03_RNA-counts_tSNE_recoverd-doublets.png",
  ...
  ggsave(
    filename = "03_RNA-counts_UMAP_recoverd-doublets.png",
  ...
  ggsave(
    filename = "03_RNA-counts_UMAP_doublet_neighbors.png",
  ...
  ggsave(
    filename = "03_RNA_neighbor-doublet-calling.png",
  ...
  ggsave(
    filename = "03_RNA-counts_UMAP_neighbor-doublets.png",
  ...
  ggsave(
    filename = "03_RNA-counts_violin_doublet_distribution.png",
  ...
  ggsave(
    filename = "04_RNA-counts_violin_sample.png",
  ...
  ggsave(
    filename = "04_SCT_UMAP_sample.png",
  ...
  if ("nuclei" %in% lib.tib[["seq_type"]]) {
    ...
    tmp.df <- data.frame(
      ReadType = c("Spliced", "Unspliced", "Spliced", "Unspliced"),
  ...
  if ("hto" %in% lib.tib[["library_type"]]) {
    ...
    tmp.df.hto <- data.frame(
      ...
      CountSum = c(
        tmp.counts.rna.uncalled, tmp.counts.rna.negative, tmp.counts.rna.singlet, tmp.counts.rna.doublet,
        tmp.counts.hto.uncalled, tmp.counts.hto.negative, tmp.counts.hto.singlet, tmp.counts.hto.doublet
      ),
      CountPer = c(
        tmp.percen.rna.uncalled, tmp.percen.rna.negative, tmp.percen.rna.singlet, tmp.percen.rna.doublet,
        tmp.percen.hto.uncalled, tmp.percen.hto.negative, tmp.percen.hto.singlet, tmp.percen.hto.doublet
      ),
      Labelpos = c(
        tmp.labpos.rna.uncalled, tmp.labpos.rna.negative, tmp.labpos.rna.singlet, tmp.labpos.rna.doublet,
        tmp.labpos.hto.uncalled, tmp.labpos.hto.negative, tmp.labpos.hto.singlet, tmp.labpos.hto.doublet
      ),
      LibraryID = c(
        q.lib.10x, q.lib.10x, q.lib.10x, q.lib.10x,
    ...
    p <- ggplot(mapping = aes(
      x = feature.dump.10x$DeduplicatedReads,
      ...
      scale_y_log10() +
      scale_color_manual(
        values = c(my.cols[["Doublet"]], my.cols[["Negative"]], my.cols[["Singlet"]], my.cols[["Uncalled"]]),
    ...
    ggsave(
      filename = "04_UMI-UMI_scatter_global.png",
      plot = p,
      path = file.path(plot.path, rnx),
      width = 8,
      height = 6,
...
if ("nuclei" %in% lib.tib[["seq_type"]]) {
  ...
  ggsave(
    filename = "05_UMI-distribution_splice-class.png",
...
if ("hto" %in% lib.tib[["library_type"]]) {
  p.distribution.hto <- ggplot(
    ...
    facet_wrap(~Library) +
    coord_flip() +
    ggtitle("UMI distribution by HTO class") +
    xlab("Library ID") +
    ylab("UMI counts") +
  ...
  ggsave(
    filename = "05_UMI-distribution_HTO-class.png",
